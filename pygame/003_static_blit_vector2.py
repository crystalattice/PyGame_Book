    ...
    def run(self):
        ...
        while running:
            ...
            if pressed[pygame.K_LSHIFT]:
                ...
                Ball(self.screen, self.yanniks_ship.startpoint, c, color=(200,20,0), bossnumber=self.yanniks_ship.number)                      
            
            if pressed[pygame.K_RSHIFT]:                                                
            #if random.random() < 0.1:
                Ball(self.screen, self.pixelhirn.startpoint,  d, color=(0,0,200), bossnumber=self.pixelhirn.number)   
